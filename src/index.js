...
const grassTiles = [];
loadTextureSet(grassTiles,"grass-tile", 3);
...
const forestTiles = [];
loadTextureSet(forestTiles,"forest-tile", 1);
const forestSprite = new PIXI.TilingSprite(
    grassTiles[1],
)

// Create the TilingSprites for the four sides of the square
const northForest = new PIXI.TilingSprite(grassTiles[2], playableAreaBounds.maxX, 500);
const eastForest = new PIXI.TilingSprite(grassTiles[2], 500, playableAreaBounds.maxY);
const southForest = new PIXI.TilingSprite(grassTiles[2], playableAreaBounds.maxX, 500);
const westForest = new PIXI.TilingSprite(grassTiles[2], 500, playableAreaBounds.maxY);
